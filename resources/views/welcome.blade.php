...
<head>
    ...
    <!-- Fonts -->
    <link rel="preconnect" href="https:/<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="welcome-section">
        ...
        <div class="btn-container">
            <a href="{{route('categories.index')}}" class="btn btn-primary mr-2">Category</a>
            <a href="{{route('products.index')}}" class="btn btn-secondary">Product</a>
        </div>
    </div>
